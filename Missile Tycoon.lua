    ...
    Callback = function(Val)
        if Val then
            ...
            ViewRender = RunService.RenderStepped:Connect(function()
                ...
                ViewPart.Size = Vector3.new(sizeX, 1, sizeZ)
                ViewPart.Position = Vector3.new((minX + maxX) / 2, LocalPlayer.Character and LocalPlayer.Character.PrimaryPart and LocalPlayer.Character.PrimaryPart.Position.Y - 3 or 0, (minZ + maxZ) / 2)
            end)
        else
            ...
            task.spawn(function()
                ...
                while _G.AutoLoop do
                    ...
                    if currentId then
                        ...
                        -- Aligns exactly inside the target coordinate boundaries
                        ...
                        if targetZ <= maxZ then
                            ...
                            Rayfield:Notify({Title="Grid Full", Content="Selection area limits reached!", Duration=3})
                            _G.AutoLoop = false
                            break
                        end
                    end
