        ...
        if success and res and res.Body then
            ...
            if body and body.data then
                for _, v in ipairs(body.data) do
                    if type(v) == "table" and v.playing and v.maxPlayers and v.playing < v.maxPlayers and v.id ~= game.JobId then table.insert(servers, v.id) end
                end
            end
        end
    end
...
local function GetBuildingsCount(plr) if plr and plr:FindFirstChild("leaderstats") and plr.leaderstats:FindFirstChild("Buildings") then return plr.leaderstats.Buildings.Value end return 0 end
